...
1. 下载相关安装包
   ...
   地址: http://repo.yandex.ru/clickhouse/deb/stable/main/
   
   文件: clickhouse-server-common_19.1.7_all.deb
        clickhouse-server-base_19.1.7_amd64.deb
        clickhouse-client_19.1.7_all.deb
...
2. 创建相关目录
   ...
   mkdir -p /data/clickhouse/user_file
...
1. 下载相关安装包
   ...
   文件:  clickhouse-server-common-19.1.7-1.el6.x86_64.rpm
         clickhouse-server-19.1.7-1.el6.x86_64.rpm
         clickhouse-common-static-19.1.7-1.el6.x86_64.rpm
         clickhouse-client-19.1.7-1.el6.x86_64.rpm
         clickhouse-test-19.1.7-1.el6.x86_64.rpm
...
3. 安装
   rpm -ivh clickhouse-server-common-19.1.7-1.el6.x86_64.rpm
   rpm -ivh clickhouse-server-19.1.7-1.el6.x86_64.rpm
   rpm -ivh clickhouse-common-static-19.1.7-1.el6.x86_64.rpm
   rpm -ivh clickhouse-test-19.1.7-1.el6.x86_64.rpm
   rpm -ivh clickhouse-client-19.1.7-1.el6.x86_64.rpm
